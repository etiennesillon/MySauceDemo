...
public class MyJIRAClient {
    ...
    public static String JIRA_BASE_URL = System.getenv("JIRA_BASE_URL");
    public static String JIRA_TOKEN = System.getenv("JIRA_TOKEN");
    public static String JIRA_USER_NAME = System.getenv("JIRA_USER_NAME");
    public static String JIRA_PASSWORD = System.getenv("JIRA_PASSWORD");
	...
	public static String sendHttpPost(String url, JSONObject payload) {
    	...
    	post.addHeader("Authorization" , "Basic " + JIRA_TOKEN);
	...
	public static String sendHttpGet(String url) {
        ...
        try {
       	 	...
       	 	UsernamePasswordCredentials creds = new UsernamePasswordCredentials(JIRA_USER_NAME, JIRA_PASSWORD);
